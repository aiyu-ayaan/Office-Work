...
// ___________________________ Fetching data from ACF ___________________________
...
<script>
    const contentFrameData = <?php echo json_encode($content_frame_data); ?>;
    console.log("Content Frame Data:", contentFrameData);
</script>
                    ...
                    if (!empty($post_ids_array)) :
                       ...
                       if ($custom_posts->have_posts()) :
                            ...
                            while ($custom_posts->have_posts()) : $custom_posts->the_post();
                                ...
                                // Fetch read_minutes TODO: Code here 
