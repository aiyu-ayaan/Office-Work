            ...
            <div class="entry-content clear" data-ast-blocks-layout="true" itemprop="text">
                            ...
                            <div class="wrapper">
                                ...
                                foreach ($all_sub_services as $key => $sub_service_list) {
                                    if (!empty($sub_service_list) && is_array($sub_service_list)) {
                                        if (!isset($sub_service_list[5]) && isset($sub_service_list[2])) {
                                            $sub_service_list[5] = $sub_service_list[2];
                                        }
                                        if (!isset($sub_service_list[6]) && isset($sub_service_list[3])) {
                                            $sub_service_list[6] = $sub_service_list[3];
                                        }
                                        if (!isset($sub_service_list[7]) && isset($sub_service_list[4])) {
                                            $sub_service_list[7] = $sub_service_list[4];
                                        }
                                        if (!isset($sub_service_list[8]) && isset($sub_service_list[5])) {
                                            $sub_service_list[8] = $sub_service_list[5];
                                        }
                ...
                <script>
                    ...
                    function startInterval() {
                        autoplayInterval = setInterval(() => {
                            ...
                            const circle_fg = document.querySelectorAll(".circle-fg")[currentIndex];
                    ...
                    document.addEventListener("DOMContentLoaded", function(event) {
                        ...
                        completeContainer.addEventListener("mouseenter", stopInterval);
                        completeContainer.addEventListener("mouseleave", resumeInterval);
                ...
                <div class="section-header-container featured-insight-header-area">
                    <h2 class="main-header large-size font-bold">
                        <?php echo esc_html($featured_insights_section_heading) ?>
                    </h2>
                    <h3 class="sub-header small-size">
                        <?php echo esc_html($text_below_featured_insights_heading) ?>
                    </h3>
                </div>
                            ...
                            <div class="column">
                                <div class="item no-radius-left"
                                    ...
                                    <div class="item-content">
                                        ...
                                        <a href="<?php echo esc_html($left_landscape_image_button_url) ?>"
                                            class="learn-more-btn smaller-size underline-on-hover"><span>
                                                <?php echo esc_html($left_landscape_image_button_text) ?>
                                            </span></a>
                                    </div>
                                    <div class="svg-container-bottom-left">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="144" height="210"
                                            viewBox="0 0 144 210" fill="none">
                                            <path
                                                d="M-65 107.475H36.0027C36.0017 134.401 25.36 160.224 6.41848 179.263C-12.523 198.303 -38.2128 208.999 -65 209V107.475Z"
                                                stroke="white" stroke-width="2" />
                                            <path
                                                d="M41.9963 209H143C142.999 182.074 132.358 156.251 113.416 137.211C94.474 118.172 68.7838 107.475 41.9963 107.475V209Z"
                                                stroke="white" stroke-width="2" />
                                            <path
                                                d="M143 102.525H41.9963C41.9971 75.5987 52.6389 49.7756 71.5807 30.7361C90.5224 11.6966 116.213 1.00027 143 1V102.525Z"
                                                stroke="#00CCFF" stroke-width="2" />
                                            <path
                                                d="M36.0017 102.525H-65C-64.9992 75.5991 -54.3577 49.7763 -35.4164 30.7369C-16.4751 11.6974 9.21465 1.00081 36.0017 1V102.525Z"
                                                stroke="white" stroke-width="2" />
                                        </svg>
                                    </div>
                                </div>
                                <div class="item no-grey video-block bottom-left"
                                    ...
                                    <div class="item-content">
                                        <p class="learn-more-btn smaller-size underline-on-hover">
                            ...
                            <div class="column">
                                <div class="item bottom-left "
                                    ...
                                    <div class="item-content">
                                        ...
                                        <a href="<?php echo esc_html($right_grid_top_left_image_button_url) ?>"
                                            class="learn-more-btn smaller-size underline-on-hover"><span>Read
                                                More</span></a>
                                    </div>
                                </div>
                                <div class="item bottom-left " data-url="">
                                    <img class="manual-lazy-load"
                                        data-src="<?php echo esc_html($right_grid_bottom_left_image) ?>"
                                        alt="Image 4"
                                        src="data:image/svg+xml,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 1 1'%3E%3C/svg%3E" />
                                    <div class="item-content">
                                        <p class="smaller-size who-we-are-desc">
                                        ...
                                        <a href="/" class="learn-more-btn smaller-size underline-on-hover"><span>Read
                                                More</span></a>
                                    </div>
                                </div>
                                <div class="item no-grey video-block display-mobile bottom-left"
                                    data-url="<?php echo esc_html($left_video_url) ?>">
                                    <img class="who-we-are-video  manual-lazy-load"
                                        data-src="<?php echo esc_html($left_video_thumbnail) ?>"
                                        src="data:image/svg+xml,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 1 1'%3E%3C/svg%3E" />
                                    ...
                                    <div class="item-content">
                                        <p class="learn-more-btn smaller-size underline-on-hover">Expertise and <br>
                                            Leadership</p>
                                    </div>
                                </div>
                            </div>
                            <div class="column">
                                <div class="no-radius-right item bottom-left " data-url="">
                                    ...
                                    <div class="svg-container-bottom-right">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="50" height="146" viewBox="0 0 50 146"
                                            fill="none">
                                            <path
                                                d="M118.348 52.9516C118.348 63.2267 115.46 73.2709 110.049 81.8143C104.639 90.3577 96.9486 97.0165 87.9512 100.949C78.9538 104.881 69.0533 105.91 59.5017 103.905C49.9501 101.901 41.1764 96.9527 34.29 89.6873C27.4037 82.4218 22.7139 73.165 20.8139 63.0874C18.9139 53.0098 19.8889 42.5641 23.6157 33.0712C27.3424 23.5782 33.6535 15.4644 41.7509 9.75582C49.8482 4.0472 59.3682 1.00016 69.1069 1C82.1661 1.00021 94.6904 6.47374 103.925 16.2165C113.159 25.9593 118.347 39.1733 118.347 52.9516"
                                                stroke="#00CCFF" stroke-width="2" />
                                            <path
                                                d="M136.607 145C136.607 126.112 129.496 107.998 116.837 94.6417C104.178 81.2859 87.0095 73.7827 69.1074 73.7827C51.2053 73.7827 34.0364 81.2859 21.3777 94.6417C8.719 107.998 1.60742 126.112 1.60742 145H136.607Z"
                                                stroke="white" stroke-width="2" stroke-miterlimit="10" />
                                        </svg>
                                    </div>
                                </div>
                                <div class="item no-radius-right bottom-left " data-url="">
