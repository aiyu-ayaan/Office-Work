...
$latest_news_section_main_heading =  get_field('acf_home_page_latest_news_section_heading') ?? '';
$latest_news_section_sub_heading =  get_field('acf_home_page_latest_news_sub_heading') ?? '';
            ...
            <div class="entry-content clear" data-ast-blocks-layout="true" itemprop="text">
                ...
                <script>
                    ...
                    function autoPlay(index) {
                        ...
                        const currentSrc = divHalfCircle.getAttribute("data-src");
                        if (currentSrc !== img_urls[index]) {
                            ...
                            setTimeout(() => {
                                ...
                                setTimeout(() => {
                                    divHalfCircle.classList.add("show");
                                }, 50);
                            }, 300);
                        }
                    ...
                    <div class="small-screen">
                        ...
                        <div class="card-section">
                            <div class="main-card" id="mainCard">
                                <h2 class="main-card-title small-size font-bold" id="mainTitle" aria-hidden="true"></h2>
                        ...
                        <?php if (have_rows('acf_homepage_our_clients_single_slide')) : ?>
                            <?php while (have_rows('acf_homepage_our_clients_single_slide')): the_row();
                                ...
                                <div class="item">
                                    ...
                                    <p class="smaller-size"><span>“</span>
                                        <?php echo esc_html($our_clients_text) ?><span>”</span>
                                    </p>
                                    <p class="our-client-auther">
                ...
                <?php if (!empty($who_we_are_main_header)): ?>
                    <div class="who-we-are-section  fade-in-on-scroll">
                        ...
                        <div class="container desktop-grid">
                            <div class="column">
                                <div class="item hover-zoom fade-in-on-scroll no-radius-left"
                                ...
                                <div class="fade-in-on-scroll hover-zoom item no-grey video-block bottom-left"
                                    ...
                                    <?php else : ?>
                                        ...
                                        <img class="who-we-are-video manual-lazy-load"
                                            ...
                                            src="data:image/svg+xml,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 1 1'%3E%3C/svg%3E" alt="Image 2" />
                            ...
                            <div class="column">
                                <div class="fade-in-on-scroll item bottom-left hover-zoom "
                                ...
                                <div class="fade-in-on-scroll item bottom-left hover-zoom" data-url="">
                                    <img class="manual-lazy-load"
                            ...
                            <div class="column">
                                <div class="fade-in-on-scroll no-radius-right item bottom-left hover-zoom" data-url="">
                                ...
                                <div class="fade-in-on-scroll item no-radius-right bottom-left hover-zoom" data-url="">
                        ...
                        <div class="container owl-carousel owl-carousel-mobile fade-in-on-scroll" style="display: none;"></div>
                ...
                <div class="latest-news-section">
                    <div class="our-latest-news-header">
                        ...
                        <h3 class="sub-heading small-size"><?php echo $latest_news_section_sub_heading; ?></h3>
                    ...
                    <div class="card-section">
                        ...
                        <div class="small-cards owl-carousel">
                            ...
                            <?php
                            $latest_news_items = get_field('acf_home_page_latest_news_items') ?: [];
                            if (!empty($latest_news_items)):
                                foreach ($latest_news_items as $index => $item):
                                    $card_image = $item['acf_home_page_latest_news_item_image'] ?: '';
                                    $card_title = $item['acf_home_page_latest_news_item_card_title'] ?: '';
                                    $card_description_para1 = $item['acf_home_page_latest_news_item_card_description_para_1'] ?: '';
                                    $card_description_para2 = $item['acf_home_page_latest_news_item_card_description_para_2'] ?: '';
                                    $card_button_text = $item['acf_home_page_latest_news_item_card_button_text'] ?: '';
                                    $card_button_url = $item['acf_home_page_latest_news_item_card_button_url'] ?: '';
                            ?>
