...
<?php 
$post_type = get_the_terms( get_the_ID(), 'post_type_category' );
$post_type_name = !empty($post_type) ? $post_type[0]->name : '';
                ...
                <div class="entry-content clear" data-ast-blocks-layout="true" itemprop="text">
                    ...
                    <div class="webinar-banner">
                        <div class="banner-area manual-lazy-load" data-src="<?php echo esc_url($banner_image) ?>" style="background: linear-gradient(0deg, rgba(5, 9, 14, 0.67) 14.88%, rgba(67, 102, 143, 0.00) 66.9%, rgba(58, 88, 123, 0.09) 70.37%, rgba(5, 9, 14, 0.60) 93.85%), url('data:image/svg+xml,%3Csvgxmlns=\'http://www.w3.org/2000/svg\' viewBox=\'0 0 1 1\'%3E%3C/svg%3E') lightgray -147.207px -35.184px / 110.167% 106.667% no-repeat;">
                            ...
                            <h1 class="about-us-banner-stmt medium-size"><?php echo esc_html($banner_title) ?></h1>

                            <div class="banner-buttons">
                                <button class="webinar-banner-button font-bold custom-button open-pardot-play-popup"><?php echo esc_html($vimeo_popup_button_text) ?></button>
                                <button class="webinar-banner-button font-bold custom-button openSubscribeModal open-subscribe-btn" onclick="console.log('clicked');"><?php echo esc_html($subscribe_popup_button_text) ?></button>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="share-icons">
                                    <button class="share-toggle" aria-label="Toggle share options" aria-expanded="false" aria-controls="share-list">
                                        <svg aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="36" height="69" viewBox="0 0 36 69" fill="none" focusable="false">
                                            <path d="M36 20C36 8.9543 27.0457 0 16 0H0V69H16C27.0457 69 36 60.0457 36 49V20Z" fill="#00ccff" />
