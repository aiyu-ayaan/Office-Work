                ...
                <article id="post-<?php the_ID(); ?>" <?php post_class('ast-article-single'); ?> itemscope itemtype="https://schema.org/CreativeWork">
                    <div class="ast-post-format- single-layout-1">
                        <div class="entry-content clear" data-ast-blocks-layout="true" itemprop="text">
                            ...
                            <div class="case-study-banner">
                                <div class="case-study-hero-banner">
                                    <div class="left-text-box">
                                        <h2 class="small-size case-study-text-above-title"><?php echo ($post_type); ?></h2>
                                        <h1 class="largest-size case-study-title"><?php echo $banner_title; ?></h1>
                                        <h2 class="small-size case-study-minute-read"><?php echo ($minute_read); ?></h2>
                                        <h2 class="small-size case-study-download-artical"><?php echo ($text_above_button_in_banner); ?></h2>
                                        <button class="open-download-popup custom-button case-study-download-button"><?php echo ($banner_button_text); ?></button>
                                    </div>
                                    <div class="right-container">
                                        <div class="case-study-border"></div>
                                        <div class="right-img manual-lazy-load" data-src="<?php echo ($banner_image); ?>" src="data:image/svg+xml,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 3 1'%3E%3C/svg%3E"></div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <!-- quotes section -->
                            <section class="quote-section-case-study" aria-labelledby="quote-heading">
                                <blockquote class="large-size quote"><?php echo $quote_text; ?></blockquote>
                                <blockquote class="smaller-size citation"><?php echo $quote_author; ?></blockquote>
                            </section>
