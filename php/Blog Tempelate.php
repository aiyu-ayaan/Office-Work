...
if (!empty($blog_author_section)) {
  ...
  $text_above_button = $blog_author_section['acf_blog_author_card_text_above_button'] ?? '';
  $button_text = $blog_author_section['acf_blog_author_card_button_text'] ?? '';
...
<div id="primary" <?php astra_primary_class(); ?>>
  <main id="main" class="site-main">
    <?php if (have_posts()) : while (have_posts()) : the_post(); ?>
        <article id="post-<?php the_ID(); ?>" <?php post_class('ast-article-single'); ?> itemscope itemtype="https://schema.org/BlogPosting">
          <div class="ast-post-format single-layout-1">
            <div class="entry-content clear" data-ast-blocks-layout="true" itemprop="text">
              <!-- Blog Banner            -->
              <section class="blog-banner">
                <div class="blog-bg-image manual-lazy-load"
                  data-src="<?php echo ($banner_image); ?>"
                  role="img"
                  aria-label="Background image for blog banner"
              ...
              <!-- 							blog sticky progress bar  -->
              <div class="progress-bar-wrapper">
                <div class="scroll-progress-bar"></div>
              </div>
              <!-- Blog Content Frame -->
              <div class="blog-complete-content-wrapper post-content">
                <div class="outer">
                  ...
                  <div class="main-content">
                    ...
                    if (!empty($quote_text)):
                    ?>
                      <section class="quote-section-blog" aria-labelledby="quote-heading">
                        <blockquote class="large-size quote font-bold" id="quote-heading">
                          <?php echo wp_kses_post($quote_text); ?>
                        </blockquote>
                        <?php if (!empty($quote_author)): ?>
                          <cite class="small citation font-bold">
                    ...
                    ?>
                      <section class="key-takeaways-box" aria-labelledby="key-takeaways-heading">
                        <div class="container">
                          <?php if (!empty($acf_blog_key_takeaways_section['acf_key_takeaways_section_heading'])): ?>
                            <h2 class="key-takeaways-title large-size font-bold" id="key-takeaways-heading">
                              <?php echo esc_html($acf_blog_key_takeaways_section['acf_key_takeaways_section_heading']); ?>
                            </h2>
                          <?php endif; ?>

                          <?php if (!empty($acf_blog_key_takeaways_section['acf_key_takeaways_list_items'])): ?>
                            <div class="takeaways-content small-size">
                              <?php
                              // Output list with only <ul> and <li> allowed
                    ...
                    <?php if (have_rows('acf_blog_content_blocks')): ?>
                      <?php while (have_rows('acf_blog_content_blocks')): the_row(); ?>

                        <!-- Text Block -->
                        <?php if (get_row_layout() === 'acf_blog_text_block'): ?>
                          <section class="acf-blog-content-block">
                            <div class="container">
                              <?php the_sub_field('acf_blog_text_content'); ?>
                            </div>
                          </section>

                          <!-- Image Block -->
                        <?php elseif (get_row_layout() === 'acf_blog_image_block'): ?>
                          <?php
                          ...
                          <!-- Blue Divider Block -->
                        <?php elseif (get_row_layout() === 'acf_blog_blue_divider'): ?>
                          <section class="acf-blog-blue-divider">
                            <div class="container">
                              <p><?php the_sub_field('acf_blog_divider_content'); ?></p>
                            </div>
                          </section>
