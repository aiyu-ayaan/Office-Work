...
<?php 
    ...
    // Remove HTML tags from $content_frame_benefits for get_minutes
    // $content_frame_benefits_text = wp_strip_all_tags($content_frame_benefits);
...
<!-- banner section  -->
    ...
    <div class="user-case-hero-banner">
        <div class="left-text-box">
            ...
            <p class="largest-size user-case-title"><?php echo $banner_title; ?></p>
            <h2 class="small-size user-case-minute-read"><?php echo ($minute_read); ?></h1>
                <h2 class="small-size user-case-download-artical"><?php echo ($text_above_button_in_banner); ?></h1>
...
<!-- content frame section  -->
                        <div class="main-frame">
                                ...
                                <div class="main-content">
                                    <div class="inner top">
                                        <div class="text-content-box">
                                            <div class="desc-text"><?php echo ($content_frame_left_container);?></div>
                                        </div>
                            ...
                            <div class="overlay-wrapper">
                                <div class="bottom-card"><?php echo ($content_frame_benefits);?></div>
